declare module 'rc-form' {
  ...
  export type FormTrigger = 'onChange' | 'onBlur' | 'onMouseOver' | 'onMouseMove' | 'onMouseOut' | 'onEnter' | 'onLeave';
  export type FormValidateType = 'string' | 'number' | 'boolean' | 'method' | 'regexp' | 'integer' | 'float' | 'array' | 'object' | 'enum' | 'date' | 'url' | 'hex' | 'email';
  ...
  export interface WrappedFormMethods {
    ...
    setFieldsValue(changedValues: any): void;
    setFields(maybeNestedFields: any): void;
